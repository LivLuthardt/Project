...
for d in std_d:
    for a in std_a:
        print(d, a)
        n_manual__isolated_clusters, n_manual_clusters = manual_clust(d,a)
        n_clusters.append(n_manual_clusters)
        n_isolated.append(n_manual__isolated_clusters)
        print(n_manual_clusters, n_manual__isolated_clusters)
print(n_clusters, n_isolated)