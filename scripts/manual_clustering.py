...
#plt.show()
plt.savefig(fname = 'Images/Original elbow')
plt.close('all')
...
plt.legend()
plt.savefig(fname = 'Images/Original distance histogram')
plt.close('all')
